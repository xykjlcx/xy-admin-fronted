...
export function ShellHeader({
  ...
  return (
    ...
    <header
      className={cn(
        'absolute inset-x-0 top-0 z-20 grid h-14 grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center gap-[calc(18px*var(--app-scale))] border-b border-border px-5 transition-[background-color,box-shadow,border-color] duration-200',
        scrolled
