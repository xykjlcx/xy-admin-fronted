...
import type { DeptDto, UserDetailDto, UserDto } from '@/modules/admin/users/api';
...
export const depts = createCollection<DeptDto, 'id'>(deptSeed, 'id');
export const users = createCollection<UserDto, 'id'>(userSeed, 'id');
