...
export const Route = createFileRoute('/_auth/admin/users')({
  ...
  staticData: {
    ...
    actions: [
      { key: 'user-create', code: 'iam:user:create', labelKey: 'users.actions.create' },
      { key: 'user-update', code: 'iam:user:update', labelKey: 'users.actions.edit' },
      { key: 'user-del', code: 'iam:user:del', labelKey: 'users.actions.delete' },
      { key: 'user-resign', code: 'iam:user:resign', labelKey: 'users.actions.resign' },
      { key: 'dept-create', code: 'iam:dept:create', labelKey: 'users.actions.createDept' },
      { key: 'dept-update', code: 'iam:dept:update', labelKey: 'users.actions.editDept' },
    ],
  },
