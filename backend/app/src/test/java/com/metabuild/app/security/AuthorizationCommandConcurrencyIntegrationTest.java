...
class AuthorizationCommandConcurrencyIntegrationTest {
    ...
    private static final class FailingOnceSessions implements AccountSessionPort {int calls;public AccessSession login(UUID u){return null;}public void logoutToken(String t){}public void kickoutAll(UUID u){if(calls++==0)throw new IllegalStateException("kickout");}}
