...
class AdminApiContractsTest {
    ...
    void preservesGenericTypesOnDirectoryAndPublishingPorts() {
        assertGenericMethod(
                ...
                "batchGetUsers",
                "com.metabuild.admin.api.BatchResult<java.util.UUID, com.metabuild.admin.api.UserSummary>",
                "java.util.Set<java.util.UUID>");
        assertGenericMethod(
                DepartmentDirectoryApi.class,
                "batchGetDepartments",
                "com.metabuild.admin.api.BatchResult<java.util.UUID, com.metabuild.admin.api.DepartmentSummary>",
                "java.util.Set<java.util.UUID>");
        assertGenericMethod(
                DepartmentDirectoryApi.class,
                "expandSubtree",
        ...
        assertGenericMethod(
                FileCatalogApi.class,
                "batchGetMetadata",
                "com.metabuild.admin.api.BatchResult<java.util.UUID, com.metabuild.admin.api.FileMetadata>",
                "java.util.Set<java.util.UUID>");
        assertGenericMethod(
                InboxPublisher.class,
                "publish",
                "com.metabuild.admin.api.PublishResult",
                "java.util.Collection<com.metabuild.admin.api.InboxMessageCommand>");
    }
    ...
    void doesNotPrematurelyExposeAuthOrGodApiTypes() {
        assertThrows(
                ...
                () -> Class.forName("com.metabuild.shared.kernel.CurrentUser"));
        assertThrows(
                ClassNotFoundException.class,
                () -> Class.forName("com.metabuild.shared.kernel.AuthFacade"));
        assertThrows(
                ClassNotFoundException.class,
                () -> Class.forName("com.metabuild.admin.api.AdminApi"));
    }
