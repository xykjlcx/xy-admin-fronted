...
public record MenuRow(UUID id, UUID parentId, String subsystemKey, String type, String labelKey,
    ...
    public static MenuRow directory(UUID id, UUID parentId, String subsystem, String label, String icon, int sort, boolean visible) {
        return new MenuRow(id,parentId,subsystem,"dir",label,icon,sort,visible,null,null);
    }
    public static MenuRow page(UUID id, UUID parentId, String subsystem, String label, String icon, int sort,
        ...
        return new MenuRow(id,parentId,subsystem,"menu",label,icon,sort,visible,path,permission);
    }
}
