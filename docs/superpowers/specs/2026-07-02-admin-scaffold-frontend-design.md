...
- 状态：**历史设计草案（已交付并演进）**。M0 已交付，其后完成 M1 角色/菜单、主题深化 Steps 3-9、users 纵切、DataTable 迁移。
- ⚠️ **本文 §4 目录结构与 §12/§15 交付范围（含 lastmile 双子系统、横切目录）为初版设想，已被 `docs/architecture.md` 与当前代码取代。** 阅读工程约束以 `docs/architecture.md` 为准，本文仅作设计决策的历史记录。
